...
exports.calculateBodyFat = calculateBodyFat;
 ...
 */
function calculateBodyFat({ gender, height, neck, waist, hip, units = 'imperial', }) {
    ...
    if (gender === 'male') {
        ...
        const bodyFat = 163.205 * Math.log10(waistIn + hipIn - neckIn) - 97.684 * Math.log10(heightIn) - 78.387;
        return parseFloat(bodyFat.toFixed(2));
    }
}
